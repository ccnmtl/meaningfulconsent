...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserVideoView'
        db.create_table(u'main_uservideoview', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('video_url', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('video_duration', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('seconds_viewed', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'main', ['UserVideoView'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'UserVideoView'
        db.delete_table(u'main_uservideoview')
