...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YouTubeBlock.title'
        db.add_column(u'main_youtubeblock', 'title',
                      self.gf('django.db.models.fields.TextField')(default='placeholder'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'YouTubeBlock.title'
        db.delete_column(u'main_youtubeblock', 'title')
