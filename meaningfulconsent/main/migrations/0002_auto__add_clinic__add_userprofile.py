...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Clinic'
        db.create_table(u'main_clinic', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=25)),
        ))
        db.send_create_signal(u'main', ['Clinic'])

        # Adding model 'UserProfile'
        db.create_table(u'main_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='profile', unique=True, to=orm['auth.User'])),
            ('clinic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Clinic'])),
            ('is_participant', self.gf('django.db.models.fields.BooleanField')(default=True)),
